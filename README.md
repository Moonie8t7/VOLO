...
Measured on orders it has never seen, VOLO agrees with them **64.2 percent** of
...
`masterlist/bg3-masterlist.json` covers 8,042 mods. 4,724 were
categorised from section headers modders wrote in their own orders,
1,530 from name patterns, 759 from a Nexus or mod.io listing,
18 from where their author's other catalogued mods sit, 200 inferred
from their neighbours, 27 from curated overrides, and 784 are not
categorised at all. 7,250 of the 8,042 sit on a divider position.
...
50 working orders is a small corpus, and it is the binding constraint on
...
784 mods have no category from any source. Almost all appeared in exactly one
