...
`masterlist/bg3-masterlist.json` covers 9,537 mods. 5,305 were
categorised from section headers modders wrote in their own orders,
1,904 from name patterns, 1,127 from a Nexus or mod.io listing,
...
categorised at all. 8,605 of the 9,537 sit on a divider position.
