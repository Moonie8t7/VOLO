...
Current: **59.9 percent held out**, against a 50.7 percent random baseline,
over nineteen distinct working orders.
...
figure, and the fifteen orders above 200 mods average 59.5 on their own. Read
