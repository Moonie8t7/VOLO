...
`masterlist/bg3-masterlist.json` covers 6,208 mods. 3,047 were
categorised from section headers modders wrote in their own orders,
1,504 from name patterns, 684 from a Nexus or mod.io listing,
26 from where their author's other catalogued mods sit, 243 inferred
from their neighbours, 21 from curated overrides, and 683 are not
categorised at all. 5,519 of the 6,208 sit on a divider position.
...
26 working orders is a small corpus, and it is the binding constraint on
...
683 mods have no category from any source. Almost all appeared in exactly one
