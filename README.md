...
`masterlist/bg3-masterlist.json` covers 8,017 mods. 4,779 were
categorised from section headers modders wrote in their own orders,
1,490 from name patterns, 784 from a Nexus or mod.io listing,
18 from where their author's other catalogued mods sit, 178 inferred
from their neighbours, 25 from curated overrides, and 743 are not
categorised at all. 7,266 of the 8,017 sit on a divider position.
