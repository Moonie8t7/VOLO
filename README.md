...
`masterlist/bg3-masterlist.json` covers 5,094 mods. 2,039 were
categorised from section headers modders wrote in their own orders,
1,476 from name patterns, 614 from a Nexus or mod.io listing,
28 from where their author's other catalogued mods sit, 183 inferred
from their neighbours, 21 from curated overrides, and 733 are not
categorised at all. 4,352 of the 5,094 sit on a divider position.
...
Twenty working orders is a small corpus, and it is the binding constraint on
...
733 mods have no category from any source. Almost all appeared in exactly one
