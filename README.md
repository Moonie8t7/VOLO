...
from their neighbours, 32 from curated overrides, and 735 are not
categorised at all. 9,301 of the 10,046 sit on a divider position.
...
735 mods have no category from any source. Almost all appeared in exactly one
