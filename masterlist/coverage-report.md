...
Generated 2026-08-09T10:48:04.386Z by `scripts/mine-corpus.mjs`.

## Corpus

| | |
|---|---|
| Load orders analysed | 24 |
| labelled working | 19 |
| labelled broken | 2 |
| load-after edges promoted from catalogues | 311 |
| unlabelled | 3 |
| Separator headers parsed | 317 |
| **Unique mods indexed** | **4597** |
| Seen in more than one order | 1832 |
...
this comes from. Only 1 of 24 orders carry it, because the short
...
| Name pattern fallback | 1221 | medium, needs review |
| Nexus or mod.io listing category | 482 | medium, the author's own words about what the mod is |
...
| Uncategorised | 640 | none, needs community input |
...
- **Ordering rules are not derived here.** Pairwise co-occurrence over 19
  working orders overfits badly: most pairs reflect one person's arbitrary sequencing
  rather than a real constraint. Only declared `dependencies` are emitted as hard
  edges. Revisit once submissions reach ~100 orders.
- **640 mods are `unsorted`.** These need community categorisation.
