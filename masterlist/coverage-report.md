...
Generated 2026-08-09T13:03:53.510Z by `scripts/mine-corpus.mjs`.

## Corpus

| | |
|---|---|
| Load orders analysed | 31 |
| labelled working | 25 |
| labelled broken | 3 |
| load-after edges promoted from catalogues | 328 |
| unlabelled | 3 |
| Separator headers parsed | 469 |
| **Unique mods indexed** | **5346** |
| Seen in more than one order | 2251 |
...
this comes from. Only 1 of 31 orders carry it, because the short
...
| Nexus or mod.io listing category | 593 | medium, the author's own words about what the mod is |
...
- **Ordering rules are not derived here.** Pairwise co-occurrence over 25
