...
`masterlist/bg3-masterlist.json` covers 9,427 mods. 5,193 were
categorised from section headers modders wrote in their own orders,
1,908 from name patterns, 1,124 from a Nexus or mod.io listing,
18 from where their author's other catalogued mods sit, 218 inferred
from their neighbours, 31 from curated overrides, and 935 are not
categorised at all. 8,482 of the 9,427 sit on a divider position.
...
935 mods have no category from any source. Almost all appeared in exactly one
