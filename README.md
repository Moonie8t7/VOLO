...
`masterlist/bg3-masterlist.json` covers 9,227 mods. 5,156 were
categorised from section headers modders wrote in their own orders,
1,826 from name patterns, 1,075 from a Nexus or mod.io listing,
18 from where their author's other catalogued mods sit, 230 inferred
from their neighbours, 29 from curated overrides, and 893 are not
categorised at all. 8,325 of the 9,227 sit on a divider position.
...
58 working orders is a small corpus, and it is the binding constraint on
...
893 mods have no category from any source. Almost all appeared in exactly one
