...
`masterlist/bg3-masterlist.json` covers 9,487 mods. 5,305 were
categorised from section headers modders wrote in their own orders,
1,875 from name patterns, 1,114 from a Nexus or mod.io listing,
18 from where their author's other catalogued mods sit, 229 inferred
from their neighbours, 31 from curated overrides, and 915 are not
categorised at all. 8,562 of the 9,487 sit on a divider position.
...
62 working orders is a small corpus, and it is the binding constraint on
...
915 mods have no category from any source. Almost all appeared in exactly one
