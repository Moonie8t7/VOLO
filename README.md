...
Measured on orders it has never seen, VOLO agrees with them **60.9 percent** of
...
`masterlist/bg3-masterlist.json` covers 5,353 mods. 2,333 were
categorised from section headers modders wrote in their own orders,
1,438 from name patterns, 594 from a Nexus or mod.io listing,
27 from where their author's other catalogued mods sit, 180 inferred
from their neighbours, 21 from curated overrides, and 760 are not
categorised at all. 4,588 of the 5,353 sit on a divider position.
...
23 working orders is a small corpus, and it is the binding constraint on
...
760 mods have no category from any source. Almost all appeared in exactly one
