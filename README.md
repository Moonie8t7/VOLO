...
Measured on orders it has never seen, VOLO agrees with them **64.3 percent** of
...
`masterlist/bg3-masterlist.json` covers 8,017 mods. 4,873 were
categorised from section headers modders wrote in their own orders,
1,440 from name patterns, 758 from a Nexus or mod.io listing,
18 from where their author's other catalogued mods sit, 176 inferred
from their neighbours, 25 from curated overrides, and 727 are not
categorised at all. 7,282 of the 8,017 sit on a divider position.
...
727 mods have no category from any source. Almost all appeared in exactly one
