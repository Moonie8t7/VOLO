...
`masterlist/bg3-masterlist.json` covers 10,929 mods. 6,843 were
categorised from section headers modders wrote in their own orders,
1,866 from name patterns, 1,144 from a Nexus or mod.io listing,
17 from where their author's other catalogued mods sit, 179 inferred
from their neighbours, 42 from curated overrides, and 838 are not
categorised at all. 10,079 of the 10,929 sit on a divider position.
...
97 working orders is a small corpus, and it is the binding constraint on
...
838 mods have no category from any source. Almost all appeared in exactly one
