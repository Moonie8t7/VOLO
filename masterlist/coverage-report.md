...
Generated 2026-08-17T13:48:42.123Z by `scripts/mine-corpus.mjs`.

## Corpus

| | |
|---|---|
| Load orders analysed | 95 |
| labelled working | 79 |
| labelled broken | 14 |
| load-after edges promoted from catalogues | 579 |
| unlabelled | 2 |
| Separator headers parsed | 1879 |
| **Unique mods indexed** | **9504** |
| Seen in more than one order | 6230 |
...
this comes from. Only 2 of 95 orders carry it, because the short
...
| Nexus or mod.io listing category | 1119 | medium, the author's own words about what the mod is |
...
| Uncategorised | 918 | none, needs community input |
...
|---|---|---|---|
| Category pairs against the working consensus | 21.6% | 22.9% | no, and it points the other way |
| Mods in no working order anywhere | 10% | 0% | yes |
| Declared dependencies not installed | 0.1 | 0.0 | yes |

Measured over 14 broken and 79 working orders, against 170 category conventions, each held by at least 75 percent of at least 500 observed pairs.
...
- **Ordering rules are not derived here.** Pairwise co-occurrence over 79
  working orders overfits badly: most pairs reflect one person's arbitrary sequencing
  rather than a real constraint. Only declared `dependencies` are emitted as hard
  edges. Revisit once submissions reach ~100 orders.
- **918 mods are `unsorted`.** These need community categorisation.
