...
Measured on orders it has never seen, VOLO agrees with them **60.8 percent** of
...
`masterlist/bg3-masterlist.json` covers 5,286 mods. 2,333 were
categorised from section headers modders wrote in their own orders,
1,420 from name patterns, 580 from a Nexus or mod.io listing,
27 from where their author's other catalogued mods sit, 174 inferred
from their neighbours, 21 from curated overrides, and 731 are not
categorised at all. 4,550 of the 5,286 sit on a divider position.
...
731 mods have no category from any source. Almost all appeared in exactly one
