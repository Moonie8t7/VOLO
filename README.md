...
Measured on orders it has never seen, VOLO agrees with them **61.0 percent** of
...
`masterlist/bg3-masterlist.json` covers 6,415 mods. 3,240 were
categorised from section headers modders wrote in their own orders,
1,498 from name patterns, 704 from a Nexus or mod.io listing,
26 from where their author's other catalogued mods sit, 228 inferred
from their neighbours, 22 from curated overrides, and 697 are not
categorised at all. 5,712 of the 6,415 sit on a divider position.
...
28 working orders is a small corpus, and it is the binding constraint on
...
697 mods have no category from any source. Almost all appeared in exactly one
