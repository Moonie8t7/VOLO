...
Measured on orders it has never seen, VOLO agrees with them **61.9 percent** of
...
`masterlist/bg3-masterlist.json` covers 7,508 mods. 4,570 were
categorised from section headers modders wrote in their own orders,
1,363 from name patterns, 652 from a Nexus or mod.io listing,
16 from where their author's other catalogued mods sit, 183 inferred
from their neighbours, 24 from curated overrides, and 700 are not
categorised at all. 6,800 of the 7,508 sit on a divider position.
...
38 working orders is a small corpus, and it is the binding constraint on
...
700 mods have no category from any source. Almost all appeared in exactly one
