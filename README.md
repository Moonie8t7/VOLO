...
Measured on orders it has never seen, VOLO agrees with them **59.4 percent** of
...
`masterlist/bg3-masterlist.json` covers 4,295 mods. 1,640 were
categorised from section headers modders wrote in their own orders,
1,273 from name patterns, 490 from a Nexus or mod.io listing,
29 from where their author's other catalogued mods sit, 158 inferred
from their neighbours, 20 from curated overrides, and 685 are not
categorised at all. 3,602 of the 4,295 sit on a divider position.
...
Sixteen working orders is a small corpus, and it is the binding constraint on
...
685 mods have no category from any source. Almost all appeared in exactly one
