...
Generated 2026-08-10T19:57:41.803Z by `scripts/mine-corpus.mjs`.

## Corpus

| | |
|---|---|
| Load orders analysed | 53 |
| labelled working | 45 |
| labelled broken | 5 |
| load-after edges promoted from catalogues | 433 |
| unlabelled | 3 |
| Separator headers parsed | 1178 |
| **Unique mods indexed** | **7630** |
| Seen in more than one order | 4041 |
...
this comes from. Only 2 of 53 orders carry it, because the short
...
| Name pattern fallback | 1404 | medium, needs review |
| Nexus or mod.io listing category | 702 | medium, the author's own words about what the mod is |
...
| Uncategorised | 726 | none, needs community input |
...
|---|---|---|---|
| Category pairs against the working consensus | 12.5% | 24.0% | no, and it points the other way |
| Mods in no working order anywhere | 7% | 1% | yes |
| Declared dependencies not installed | 0.0 | 0.0 | no |

Measured over 5 broken and 43 working orders, against 155 category conventions, each held by at least 75 percent of at least 500 observed pairs.
...
- **Ordering rules are not derived here.** Pairwise co-occurrence over 45
  working orders overfits badly: most pairs reflect one person's arbitrary sequencing
  rather than a real constraint. Only declared `dependencies` are emitted as hard
  edges. Revisit once submissions reach ~100 orders.
- **726 mods are `unsorted`.** These need community categorisation.
