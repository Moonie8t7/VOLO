...
Measured on orders it has never seen, VOLO agrees with them **67.5 percent** of
...
`masterlist/bg3-masterlist.json` covers 11,239 mods. 6,951 were
categorised from section headers modders wrote in their own orders,
1,985 from name patterns, 1,167 from a Nexus or mod.io listing,
...
categorised at all. 10,342 of the 11,239 sit on a divider position.
