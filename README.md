...
`masterlist/bg3-masterlist.json` covers 9,502 mods. 5,305 were
categorised from section headers modders wrote in their own orders,
1,883 from name patterns, 1,118 from a Nexus or mod.io listing,
18 from where their author's other catalogued mods sit, 230 inferred
from their neighbours, 31 from curated overrides, and 917 are not
categorised at all. 8,575 of the 9,502 sit on a divider position.
...
64 working orders is a small corpus, and it is the binding constraint on
...
917 mods have no category from any source. Almost all appeared in exactly one
