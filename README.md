...
Measured on orders it has never seen, VOLO agrees with them **62.0 percent** of
...
`masterlist/bg3-masterlist.json` covers 7,787 mods. 4,627 were
categorised from section headers modders wrote in their own orders,
1,448 from name patterns, 724 from a Nexus or mod.io listing,
16 from where their author's other catalogued mods sit, 173 inferred
from their neighbours, 27 from curated overrides, and 772 are not
categorised at all. 7,007 of the 7,787 sit on a divider position.
...
43 working orders is a small corpus, and it is the binding constraint on
...
772 mods have no category from any source. Almost all appeared in exactly one
