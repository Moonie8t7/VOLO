...
`masterlist/bg3-masterlist.json` covers 9,492 mods. 5,305 were
categorised from section headers modders wrote in their own orders,
1,878 from name patterns, 1,116 from a Nexus or mod.io listing,
18 from where their author's other catalogued mods sit, 230 inferred
from their neighbours, 31 from curated overrides, and 914 are not
categorised at all. 8,568 of the 9,492 sit on a divider position.
...
63 working orders is a small corpus, and it is the binding constraint on
...
914 mods have no category from any source. Almost all appeared in exactly one
