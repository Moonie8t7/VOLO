...
Measured on orders it has never seen, VOLO agrees with them **62.3 percent** of
...
`masterlist/bg3-masterlist.json` covers 7,788 mods. 4,630 were
categorised from section headers modders wrote in their own orders,
1,447 from name patterns, 724 from a Nexus or mod.io listing,
16 from where their author's other catalogued mods sit, 184 inferred
from their neighbours, 27 from curated overrides, and 760 are not
categorised at all. 7,020 of the 7,788 sit on a divider position.
...
44 working orders is a small corpus, and it is the binding constraint on
