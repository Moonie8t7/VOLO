...
Measured on orders it has never seen, VOLO agrees with them **60.0 percent** of
...
`masterlist/bg3-masterlist.json` covers 4,604 mods. 2,039 were
categorised from section headers modders wrote in their own orders,
1,223 from name patterns, 484 from a Nexus or mod.io listing,
28 from where their author's other catalogued mods sit, 167 inferred
from their neighbours, 21 from curated overrides, and 642 are not
categorised at all. 3,953 of the 4,604 sit on a divider position.
...
Eighteen working orders is a small corpus, and it is the binding constraint on
...
642 mods have no category from any source. Almost all appeared in exactly one
