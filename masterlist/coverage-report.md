...
Generated 2026-09-21T05:35:25.976Z by `scripts/mine-corpus.mjs`.

## Corpus

| | |
|---|---|
| Load orders analysed | 177 |
| labelled working | 143 |
| labelled broken | 32 |
| load-after edges promoted from catalogues | 801 |
| unlabelled | 2 |
| Separator headers parsed | 4322 |
| **Unique mods indexed** | **11092** |
| Seen in more than one order | 7839 |
| With declared dependencies | 771 |
...
this comes from. Only 3 of 177 orders carry it, because the short
...
| Name pattern fallback | 1911 | medium, needs review |
| Nexus or mod.io listing category | 1141 | medium, the author's own words about what the mod is |
...
|---|---|---|---|
| Category pairs against the working consensus | 18.2% | 20.7% | no, and it points the other way |
| Mods in no working order anywhere | 7% | 0% | yes |
| Declared dependencies not installed | 0.0 | 0.0 | no |

Measured over 32 broken and 143 working orders, against 135 category conventions, each held by at least 75 percent of at least 500 observed pairs.
...
- **Ordering rules are not derived here.** Pairwise co-occurrence over 143
