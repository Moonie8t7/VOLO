...
Current: **59.4 percent held out**, against a 50.6 percent random baseline,
over sixteen distinct working orders.
...
figure, and the thirteen orders above 200 mods average 59.4 on their own. Read
