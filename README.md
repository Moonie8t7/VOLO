...
`masterlist/bg3-masterlist.json` covers 11,243 mods. 6,976 were
categorised from section headers modders wrote in their own orders,
1,976 from name patterns, 1,159 from a Nexus or mod.io listing,
...
categorised at all. 10,356 of the 11,243 sit on a divider position.
