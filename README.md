...
`masterlist/bg3-masterlist.json` covers 11,735 mods. 6,829 were
categorised from section headers modders wrote in their own orders,
2,382 from name patterns, 1,231 from a Nexus or mod.io listing,
...
categorised at all. 10,755 of the 11,735 sit on a divider position.
