...
Measured on orders it has never seen, VOLO agrees with them **61.1 percent** of
...
`masterlist/bg3-masterlist.json` covers 6,296 mods. 3,240 were
categorised from section headers modders wrote in their own orders,
1,436 from name patterns, 668 from a Nexus or mod.io listing,
26 from where their author's other catalogued mods sit, 238 inferred
from their neighbours, 22 from curated overrides, and 666 are not
categorised at all. 5,624 of the 6,296 sit on a divider position.
...
27 working orders is a small corpus, and it is the binding constraint on
...
666 mods have no category from any source. Almost all appeared in exactly one
