...
`masterlist/bg3-masterlist.json` covers 10,356 mods. 6,648 were
categorised from section headers modders wrote in their own orders,
1,664 from name patterns, 1,045 from a Nexus or mod.io listing,
17 from where their author's other catalogued mods sit, 177 inferred
from their neighbours, 34 from curated overrides, and 771 are not
categorised at all. 9,574 of the 10,356 sit on a divider position.
...
771 mods have no category from any source. Almost all appeared in exactly one
