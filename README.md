...
Measured on orders it has never seen, VOLO agrees with them **59.9 percent** of
...
`masterlist/bg3-masterlist.json` covers 4,769 mods. 2,039 were
categorised from section headers modders wrote in their own orders,
1,304 from name patterns, 533 from a Nexus or mod.io listing,
28 from where their author's other catalogued mods sit, 173 inferred
from their neighbours, 21 from curated overrides, and 671 are not
categorised at all. 4,089 of the 4,769 sit on a divider position.
...
Nineteen working orders is a small corpus, and it is the binding constraint on
...
671 mods have no category from any source. Almost all appeared in exactly one
