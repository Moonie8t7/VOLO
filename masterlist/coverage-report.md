...
Generated 2026-08-09T13:55:10.480Z by `scripts/mine-corpus.mjs`.

## Corpus

| | |
|---|---|
| Load orders analysed | 32 |
| labelled working | 26 |
| labelled broken | 3 |
| load-after edges promoted from catalogues | 328 |
| unlabelled | 3 |
| Separator headers parsed | 469 |
| **Unique mods indexed** | **5353** |
| Seen in more than one order | 2259 |
...
this comes from. Only 1 of 32 orders carry it, because the short
...
| Name pattern fallback | 1438 | medium, needs review |
| Nexus or mod.io listing category | 594 | medium, the author's own words about what the mod is |
...
- **Ordering rules are not derived here.** Pairwise co-occurrence over 26
