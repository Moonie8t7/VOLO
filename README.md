...
Measured on orders it has never seen, VOLO agrees with them **63.1 percent** of
...
`masterlist/bg3-masterlist.json` covers 7,868 mods. 4,630 were
categorised from section headers modders wrote in their own orders,
1,483 from name patterns, 741 from a Nexus or mod.io listing,
16 from where their author's other catalogued mods sit, 192 inferred
from their neighbours, 27 from curated overrides, and 779 are not
categorised at all. 7,081 of the 7,868 sit on a divider position.
...
46 working orders is a small corpus, and it is the binding constraint on
...
779 mods have no category from any source. Almost all appeared in exactly one
