...
Measured on orders it has never seen, VOLO agrees with them **58.7 percent** of
...
`masterlist/bg3-masterlist.json` covers 3,480 mods. 1,640 were
categorised from section headers modders wrote in their own orders,
900 from name patterns, 338 from a Nexus or mod.io listing,
29 from where their author's other catalogued mods sit, 95 inferred
from their neighbours, 16 from curated overrides, and 462 are not
categorised at all. 3,010 of the 3,480 sit on a divider position.
...
Twelve working orders is a small corpus, and it is the binding constraint on
...
462 mods have no category from any source. Almost all appeared in exactly one
