...
Measured on orders it has never seen, VOLO agrees with them **64.8 percent** of
...
`masterlist/bg3-masterlist.json` covers 9,306 mods. 5,156 were
categorised from section headers modders wrote in their own orders,
1,859 from name patterns, 1,085 from a Nexus or mod.io listing,
18 from where their author's other catalogued mods sit, 231 inferred
from their neighbours, 31 from curated overrides, and 926 are not
categorised at all. 8,370 of the 9,306 sit on a divider position.
...
60 working orders is a small corpus, and it is the binding constraint on
...
926 mods have no category from any source. Almost all appeared in exactly one
