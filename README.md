...
Measured on orders it has never seen, VOLO agrees with them **63.8 percent** of
...
`masterlist/bg3-masterlist.json` covers 7,915 mods. 4,724 were
categorised from section headers modders wrote in their own orders,
1,459 from name patterns, 730 from a Nexus or mod.io listing,
16 from where their author's other catalogued mods sit, 191 inferred
from their neighbours, 27 from curated overrides, and 768 are not
categorised at all. 7,139 of the 7,915 sit on a divider position.
...
49 working orders is a small corpus, and it is the binding constraint on
...
768 mods have no category from any source. Almost all appeared in exactly one
