...
Measured on orders it has never seen, VOLO agrees with them **66.7 percent** of
...
`masterlist/bg3-masterlist.json` covers 11,745 mods. 6,829 were
...
from their neighbours, 48 from curated overrides, and 971 are not
categorised at all. 10,762 of the 11,745 sit on a divider position.
...
94 working orders is a small corpus, and it is the binding constraint on
...
971 mods have no category from any source. Almost all appeared in exactly one
