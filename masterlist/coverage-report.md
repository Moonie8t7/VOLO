...
Generated 2026-09-20T12:08:58.493Z by `scripts/mine-corpus.mjs`.

## Corpus

| | |
|---|---|
| Load orders analysed | 176 |
| labelled working | 142 |
| labelled broken | 32 |
| load-after edges promoted from catalogues | 801 |
| unlabelled | 2 |
| Separator headers parsed | 4322 |
| **Unique mods indexed** | **11085** |
| Seen in more than one order | 7835 |
...
this comes from. Only 3 of 176 orders carry it, because the short
...
Measured over 32 broken and 142 working orders, against 135 category conventions, each held by at least 75 percent of at least 500 observed pairs.
...
- **Ordering rules are not derived here.** Pairwise co-occurrence over 142
