...
Measured on orders it has never seen, VOLO agrees with them **61.8 percent** of
...
`masterlist/bg3-masterlist.json` covers 7,622 mods. 4,570 were
categorised from section headers modders wrote in their own orders,
1,398 from name patterns, 701 from a Nexus or mod.io listing,
16 from where their author's other catalogued mods sit, 189 inferred
from their neighbours, 24 from curated overrides, and 724 are not
categorised at all. 6,890 of the 7,622 sit on a divider position.
...
39 working orders is a small corpus, and it is the binding constraint on
...
724 mods have no category from any source. Almost all appeared in exactly one
