...
`masterlist/bg3-masterlist.json` covers 7,770 mods. 4,570 were
categorised from section headers modders wrote in their own orders,
1,480 from name patterns, 727 from a Nexus or mod.io listing,
16 from where their author's other catalogued mods sit, 184 inferred
from their neighbours, 27 from curated overrides, and 766 are not
categorised at all. 6,996 of the 7,770 sit on a divider position.
...
42 working orders is a small corpus, and it is the binding constraint on
...
766 mods have no category from any source. Almost all appeared in exactly one
