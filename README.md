...
`masterlist/bg3-masterlist.json` covers 11,007 mods. 6,929 were
categorised from section headers modders wrote in their own orders,
1,872 from name patterns, 1,136 from a Nexus or mod.io listing,
17 from where their author's other catalogued mods sit, 191 inferred
from their neighbours, 42 from curated overrides, and 820 are not
categorised at all. 10,175 of the 11,007 sit on a divider position.
...
820 mods have no category from any source. Almost all appeared in exactly one
