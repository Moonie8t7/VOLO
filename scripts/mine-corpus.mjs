...
const GROUPS = [
  ...
  { name: 'Resources',               after: ['User Interface'],   description: 'Shared libraries and frameworks other mods depend on' },
  { name: 'Visuals',                 after: ['Resources'],            description: 'Textures and visual effects' },
  { name: 'Gameplay',                after: ['Visuals'],                 description: 'Rules, mechanics, combat and progression' },
  { name: 'Utilities',               after: ['Gameplay'],                     description: 'Loaders, mod fixers and script extender support' },
  { name: 'Quests',                  after: ['Utilities'],               description: 'New and altered quests' },
  { name: 'Environment',             after: ['Quests'],                    description: 'World, lighting and level changes' },
  { name: 'Equipment',               after: ['Environment'],                 description: 'General gear, consumables and containers' },
  { name: 'Accessories',             after: ['Equipment'],                  description: 'Jewellery, cloaks and trinkets' },
  { name: 'Armor',                   after: ['Accessories'],                 description: 'Armour sets and pieces' },
  { name: 'Clothing',                after: ['Armor'],                      description: 'Outfits and camp clothing' },
  { name: 'Dyes',                    after: ['Clothing'],                   description: 'Dyes and colour options' },
  { name: 'Weapons',                 after: ['Dyes'],                   description: 'Weapons' },
  { name: 'Spells',                  after: ['Weapons'],                description: 'Spell additions and overhauls' },
  { name: 'Races',                   after: ['Spells'],                 description: 'Races, subraces and lineages' },
  ...
  { name: 'Heads',                   after: ['Character Customization'],                      description: 'Heads, faces and eyes' },
  ...
  { name: 'Animations',              after: ['Companions'],                     description: 'Animation replacements and additions' },
  { name: 'Miscellaneous',           after: ['Animations'],                    description: 'Everything without a better home' },
  { name: 'Dice',                    after: ['Miscellaneous'],                     description: 'Dice skins' },
  { name: 'NPC',                     after: ['Dice'],                description: 'Non-companion character changes' },
  { name: 'Audio',                   after: ['NPC'],               description: 'Sound and music' },
  { name: 'Bodies',                  after: ['Audio'],                   description: 'Body models and skins' },
  { name: 'Bug Fixes',               after: ['Bodies'],             description: 'Fixes and compatibility patches' },
  { name: 'unsorted',                after: ['Bug Fixes'],                       description: 'Not yet categorised by the community' },
  { name: 'Bottom of Load Order',    after: ['unsorted'],                       description: 'Explicit tail marker' },
];
