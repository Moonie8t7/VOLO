...
`masterlist/bg3-masterlist.json` covers 9,258 mods. 5,156 were
categorised from section headers modders wrote in their own orders,
1,836 from name patterns, 1,084 from a Nexus or mod.io listing,
18 from where their author's other catalogued mods sit, 230 inferred
from their neighbours, 30 from curated overrides, and 904 are not
categorised at all. 8,345 of the 9,258 sit on a divider position.
...
904 mods have no category from any source. Almost all appeared in exactly one
