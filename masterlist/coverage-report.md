...
Generated 2026-08-29T13:30:29.815Z by `scripts/mine-corpus.mjs`.

## Corpus

| | |
|---|---|
| Load orders analysed | 124 |
| labelled working | 104 |
| labelled broken | 18 |
| load-after edges promoted from catalogues | 620 |
| unlabelled | 2 |
| Separator headers parsed | 3017 |
| **Unique mods indexed** | **10069** |
| Seen in more than one order | 7090 |
| With declared dependencies | 628 |
...
this comes from. Only 3 of 124 orders carry it, because the short
...
| Name pattern fallback | 1607 | medium, needs review |
| Nexus or mod.io listing category | 995 | medium, the author's own words about what the mod is |
...
| Uncategorised | 739 | none, needs community input |
...
|---|---|---|---|
| Category pairs against the working consensus | 19.9% | 22.8% | no, and it points the other way |
| Mods in no working order anywhere | 8% | 0% | yes |
| Declared dependencies not installed | 0.1 | 0.0 | yes |

Measured over 18 broken and 104 working orders, against 131 category conventions, each held by at least 75 percent of at least 500 observed pairs.
...
- **Ordering rules are not derived here.** Pairwise co-occurrence over 104
  working orders overfits badly: most pairs reflect one person's arbitrary sequencing
  rather than a real constraint. Only declared `dependencies` are emitted as hard
  edges. Revisit once submissions reach ~100 orders.
- **739 mods are `unsorted`.** These need community categorisation.
