...
Current: **61.1 percent held out**, against a 50.7 percent random baseline,
over 27 distinct working orders.
...
figure, and the twenty orders above 200 mods average 61.1 on their own. Read
