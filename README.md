...
`masterlist/bg3-masterlist.json` covers 7,768 mods. 4,570 were
categorised from section headers modders wrote in their own orders,
1,479 from name patterns, 727 from a Nexus or mod.io listing,
...
categorised at all. 6,994 of the 7,768 sit on a divider position.
...
41 working orders is a small corpus, and it is the binding constraint on
