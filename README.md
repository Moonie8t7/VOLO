...
1,776 from name patterns, 1,108 from a Nexus or mod.io listing,
17 from where their author's other catalogued mods sit, 175 inferred
from their neighbours, 35 from curated overrides, and 822 are not
categorised at all. 9,755 of the 10,588 sit on a divider position.
...
822 mods have no category from any source. Almost all appeared in exactly one
