...
`masterlist/bg3-masterlist.json` covers 10,326 mods. 6,648 were
categorised from section headers modders wrote in their own orders,
1,648 from name patterns, 1,040 from a Nexus or mod.io listing,
17 from where their author's other catalogued mods sit, 176 inferred
from their neighbours, 34 from curated overrides, and 763 are not
categorised at all. 9,553 of the 10,326 sit on a divider position.
