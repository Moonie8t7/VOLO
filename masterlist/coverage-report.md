...
Generated 2026-09-03T18:47:20.985Z by `scripts/mine-corpus.mjs`.

## Corpus

| | |
|---|---|
| Load orders analysed | 135 |
| labelled working | 113 |
| labelled broken | 20 |
| load-after edges promoted from catalogues | 625 |
| unlabelled | 2 |
| Separator headers parsed | 3284 |
| **Unique mods indexed** | **10294** |
| Seen in more than one order | 7246 |
...
this comes from. Only 3 of 135 orders carry it, because the short
...
| Nexus or mod.io listing category | 1031 | medium, the author's own words about what the mod is |
...
| Uncategorised | 753 | none, needs community input |
...
|---|---|---|---|
| Category pairs against the working consensus | 19.2% | 22.2% | no, and it points the other way |
| Mods in no working order anywhere | 9% | 0% | yes |
| Declared dependencies not installed | 0.1 | 0.0 | yes |

Measured over 20 broken and 113 working orders, against 130 category conventions, each held by at least 75 percent of at least 500 observed pairs.
...
- **Ordering rules are not derived here.** Pairwise co-occurrence over 113
  working orders overfits badly: most pairs reflect one person's arbitrary sequencing
  rather than a real constraint. Only declared `dependencies` are emitted as hard
  edges. Revisit once submissions reach ~100 orders.
- **753 mods are `unsorted`.** These need community categorisation.
