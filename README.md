...
Measured on orders it has never seen, VOLO agrees with them **64.5 percent** of
...
`masterlist/bg3-masterlist.json` covers 8,527 mods. 4,766 were
categorised from section headers modders wrote in their own orders,
1,728 from name patterns, 1,017 from a Nexus or mod.io listing,
18 from where their author's other catalogued mods sit, 184 inferred
from their neighbours, 29 from curated overrides, and 785 are not
categorised at all. 7,733 of the 8,527 sit on a divider position.
...
53 working orders is a small corpus, and it is the binding constraint on
...
785 mods have no category from any source. Almost all appeared in exactly one
