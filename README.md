...
Measured on orders it has never seen, VOLO agrees with them **65.5 percent** of
...
`masterlist/bg3-masterlist.json` covers 10,113 mods. 6,504 were
categorised from section headers modders wrote in their own orders,
1,628 from name patterns, 1,006 from a Nexus or mod.io listing,
17 from where their author's other catalogued mods sit, 173 inferred
from their neighbours, 34 from curated overrides, and 751 are not
categorised at all. 9,352 of the 10,113 sit on a divider position.
...
81 working orders is a small corpus, and it is the binding constraint on
