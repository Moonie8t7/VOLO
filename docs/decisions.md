...
Current: **58.9 percent held out**, against a 50.6 percent random baseline,
over fifteen distinct working orders.
...
figure, and the twelve orders above 200 mods average 58.8 on their own. Read
