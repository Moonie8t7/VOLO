...
`masterlist/bg3-masterlist.json` covers 11,616 mods. 6,655 were
categorised from section headers modders wrote in their own orders,
2,394 from name patterns, 1,259 from a Nexus or mod.io listing,
...
categorised at all. 10,615 of the 11,616 sit on a divider position.
...
90 working orders is a small corpus, and it is the binding constraint on
