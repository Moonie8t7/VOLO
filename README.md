...
Measured on orders it has never seen, VOLO agrees with them **58.6 percent** of
...
`masterlist/bg3-masterlist.json` covers 3,609 mods. 1,640 were
categorised from section headers modders wrote in their own orders,
964 from name patterns, 394 from a Nexus or mod.io listing,
29 from where their author's other catalogued mods sit, 99 inferred
from their neighbours, 16 from curated overrides, and 467 are not
categorised at all. 3,134 of the 3,609 sit on a divider position.
...
Thirteen working orders is a small corpus, and it is the binding constraint on
...
467 mods have no category from any source. Almost all appeared in exactly one
