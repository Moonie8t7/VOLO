...
Measured on orders it has never seen, VOLO agrees with them **60.1 percent** of
...
`masterlist/bg3-masterlist.json` covers 5,131 mods. 2,082 were
categorised from section headers modders wrote in their own orders,
1,471 from name patterns, 611 from a Nexus or mod.io listing,
28 from where their author's other catalogued mods sit, 184 inferred
from their neighbours, 21 from curated overrides, and 734 are not
categorised at all. 4,388 of the 5,131 sit on a divider position.
...
21 working orders is a small corpus, and it is the binding constraint on
