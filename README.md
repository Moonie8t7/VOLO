...
`masterlist/bg3-masterlist.json` covers 7,042 mods. 4,153 were
categorised from section headers modders wrote in their own orders,
1,340 from name patterns, 652 from a Nexus or mod.io listing,
16 from where their author's other catalogued mods sit, 196 inferred
from their neighbours, 23 from curated overrides, and 662 are not
categorised at all. 6,372 of the 7,042 sit on a divider position.
...
31 working orders is a small corpus, and it is the binding constraint on
...
662 mods have no category from any source. Almost all appeared in exactly one
