...
Measured on orders it has never seen, VOLO agrees with them **58.9 percent** of
...
`masterlist/bg3-masterlist.json` covers 4,075 mods. 1,640 were
categorised from section headers modders wrote in their own orders,
1,193 from name patterns, 465 from a Nexus or mod.io listing,
29 from where their author's other catalogued mods sit, 123 inferred
from their neighbours, 20 from curated overrides, and 605 are not
categorised at all. 3,462 of the 4,075 sit on a divider position.
...
Fifteen working orders is a small corpus, and it is the binding constraint on
...
605 mods have no category from any source. Almost all appeared in exactly one
