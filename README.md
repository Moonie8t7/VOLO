...
`masterlist/bg3-masterlist.json` covers 10,000 mods. 6,407 were
categorised from section headers modders wrote in their own orders,
1,627 from name patterns, 1,000 from a Nexus or mod.io listing,
17 from where their author's other catalogued mods sit, 174 inferred
from their neighbours, 32 from curated overrides, and 743 are not
categorised at all. 9,247 of the 10,000 sit on a divider position.
...
79 working orders is a small corpus, and it is the binding constraint on
