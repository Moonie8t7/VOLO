...
`masterlist/bg3-masterlist.json` covers 7,804 mods. 4,630 were
categorised from section headers modders wrote in their own orders,
1,453 from name patterns, 728 from a Nexus or mod.io listing,
16 from where their author's other catalogued mods sit, 188 inferred
from their neighbours, 27 from curated overrides, and 762 are not
categorised at all. 7,034 of the 7,804 sit on a divider position.
...
45 working orders is a small corpus, and it is the binding constraint on
...
762 mods have no category from any source. Almost all appeared in exactly one
