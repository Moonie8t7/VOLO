...
Measured on orders it has never seen, VOLO agrees with them **61.3 percent** of
...
`masterlist/bg3-masterlist.json` covers 7,072 mods. 4,153 were
categorised from section headers modders wrote in their own orders,
1,354 from name patterns, 657 from a Nexus or mod.io listing,
16 from where their author's other catalogued mods sit, 195 inferred
from their neighbours, 23 from curated overrides, and 674 are not
categorised at all. 6,390 of the 7,072 sit on a divider position.
...
33 working orders is a small corpus, and it is the binding constraint on
...
674 mods have no category from any source. Almost all appeared in exactly one
