...
Generated 2026-09-04T04:40:20.701Z by `scripts/mine-corpus.mjs`.

## Corpus

| | |
|---|---|
| Load orders analysed | 138 |
| labelled working | 115 |
| labelled broken | 21 |
| load-after edges promoted from catalogues | 627 |
| unlabelled | 2 |
| Separator headers parsed | 3284 |
| **Unique mods indexed** | **10326** |
| Seen in more than one order | 7263 |
| With declared dependencies | 634 |
...
this comes from. Only 3 of 138 orders carry it, because the short
...
| Name pattern fallback | 1648 | medium, needs review |
| Nexus or mod.io listing category | 1040 | medium, the author's own words about what the mod is |
...
Measured over 21 broken and 115 working orders, against 130 category conventions, each held by at least 75 percent of at least 500 observed pairs.
