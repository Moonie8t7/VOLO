...
`masterlist/bg3-masterlist.json` covers 10,388 mods. 6,648 were
categorised from section headers modders wrote in their own orders,
1,677 from name patterns, 1,048 from a Nexus or mod.io listing,
17 from where their author's other catalogued mods sit, 177 inferred
from their neighbours, 34 from curated overrides, and 787 are not
categorised at all. 9,590 of the 10,388 sit on a divider position.
...
787 mods have no category from any source. Almost all appeared in exactly one
