...
`masterlist/bg3-masterlist.json` covers 7,673 mods. 4,570 were
categorised from section headers modders wrote in their own orders,
1,424 from name patterns, 711 from a Nexus or mod.io listing,
16 from where their author's other catalogued mods sit, 183 inferred
from their neighbours, 27 from curated overrides, and 742 are not
categorised at all. 6,923 of the 7,673 sit on a divider position.
