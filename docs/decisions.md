...
Current: **60.0 percent held out**, against a 50.8 percent random baseline,
over eighteen distinct working orders.
...
figure, and the fourteen orders above 200 mods average 59.7 on their own. Read
