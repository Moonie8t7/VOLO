...
Generated 2026-08-10T19:38:42.769Z by `scripts/mine-corpus.mjs`.

## Corpus

| | |
|---|---|
| Load orders analysed | 52 |
| labelled working | 44 |
| labelled broken | 5 |
| load-after edges promoted from catalogues | 433 |
| unlabelled | 3 |
| Separator headers parsed | 1178 |
| **Unique mods indexed** | **7622** |
| Seen in more than one order | 4031 |
...
this comes from. Only 2 of 52 orders carry it, because the short
...
| Name pattern fallback | 1398 | medium, needs review |
| Nexus or mod.io listing category | 701 | medium, the author's own words about what the mod is |
...
| Neighbour inference, 0.85 agreement or better | 105 | high, measured 97 percent accurate at this band |
| Neighbour inference, 0.70 to 0.85 | 84 | medium, roughly 75 percent accurate, carries a confidence score |
| Uncategorised | 724 | none, needs community input |
...
|---|---|---|---|
| Category pairs against the working consensus | 12.5% | 23.8% | no, and it points the other way |
| Mods in no working order anywhere | 7% | 1% | yes |
| Declared dependencies not installed | 0.0 | 0.0 | no |

Measured over 5 broken and 42 working orders, against 155 category conventions, each held by at least 75 percent of at least 500 observed pairs.
...
- **Ordering rules are not derived here.** Pairwise co-occurrence over 44
  working orders overfits badly: most pairs reflect one person's arbitrary sequencing
  rather than a real constraint. Only declared `dependencies` are emitted as hard
  edges. Revisit once submissions reach ~100 orders.
- **724 mods are `unsorted`.** These need community categorisation.
