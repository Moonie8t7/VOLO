...
Current: **58.5 percent held out**, against a 50.6 percent random baseline,
over fourteen distinct working orders.
...
figure, and the eleven orders above 200 mods average 58.4 on their own. Read
