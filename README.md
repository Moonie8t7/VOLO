...
`masterlist/bg3-masterlist.json` covers 7,171 mods. 4,373 were
categorised from section headers modders wrote in their own orders,
1,295 from name patterns, 641 from a Nexus or mod.io listing,
16 from where their author's other catalogued mods sit, 172 inferred
from their neighbours, 23 from curated overrides, and 651 are not
categorised at all. 6,512 of the 7,171 sit on a divider position.
...
34 working orders is a small corpus, and it is the binding constraint on
...
651 mods have no category from any source. Almost all appeared in exactly one
