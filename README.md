...
Measured on orders it has never seen, VOLO agrees with them **64.1 percent** of
...
`masterlist/bg3-masterlist.json` covers 8,511 mods. 4,766 were
categorised from section headers modders wrote in their own orders,
1,722 from name patterns, 1,008 from a Nexus or mod.io listing,
18 from where their author's other catalogued mods sit, 184 inferred
from their neighbours, 29 from curated overrides, and 784 are not
categorised at all. 7,718 of the 8,511 sit on a divider position.
