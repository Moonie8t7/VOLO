...
Measured on orders it has never seen, VOLO agrees with them **61.7 percent** of
...
`masterlist/bg3-masterlist.json` covers 7,630 mods. 4,570 were
categorised from section headers modders wrote in their own orders,
1,404 from name patterns, 702 from a Nexus or mod.io listing,
16 from where their author's other catalogued mods sit, 188 inferred
from their neighbours, 24 from curated overrides, and 726 are not
categorised at all. 6,896 of the 7,630 sit on a divider position.
...
40 working orders is a small corpus, and it is the binding constraint on
...
726 mods have no category from any source. Almost all appeared in exactly one
