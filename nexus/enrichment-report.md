# Nexus enrichment report

Catalogue scanned through id 9848 of 24245 (crawl still in progress).

## Join results

| | |
|---|---|
| Masterlist mods | 7915 |
| Matched exactly by name | 1924 |
| Matched fuzzily (>= 0.9) | 487 |
| Unmatched | 5504 |
...
- 34 currently unsorted mods would receive a category from their
  Nexus listing.
- 763 mods have a Nexus category that disagrees with the
  masterlist group. Disagreement is information, not an instruction; each needs
  a look before anything changes.
- 1441 dependency edges from author-maintained Requirements tables land
  on matched masterlist mods, 681 of them resolved to a uuid on both
...
- HT_Camp Event Overhaul: ours Bug Fixes (section-majority), Nexus says Gameplay
