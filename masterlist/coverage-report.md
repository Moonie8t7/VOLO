...
Generated 2026-08-09T07:11:04.272Z by `scripts/mine-corpus.mjs`.

## Corpus

| | |
|---|---|
| Load orders analysed | 19 |
| labelled working | 14 |
| labelled broken | 2 |
| load-after edges promoted from catalogues | 292 |
| unlabelled | 3 |
| Separator headers parsed | 249 |
| **Unique mods indexed** | **3759** |
| Seen in more than one order | 1430 |
...
this comes from. Only 1 of 19 orders carry it, because the short
...
| Name pattern fallback | 1058 | medium, needs review |
| Nexus or mod.io listing category | 428 | medium, the author's own words about what the mod is |
...
- **Ordering rules are not derived here.** Pairwise co-occurrence over 14
