...
| **Unique mods indexed** | **10203** |
| Seen in more than one order | 7186 |
...
| Name pattern fallback | 1626 | medium, needs review |
...
|---|---|---|---|
| Category pairs against the working consensus | 19.8% | 23.1% | no, and it points the other way |
