...
Measured on orders it has never seen, VOLO agrees with them **60.4 percent** of
...
`masterlist/bg3-masterlist.json` covers 6,026 mods. 2,799 were
categorised from section headers modders wrote in their own orders,
1,529 from name patterns, 704 from a Nexus or mod.io listing,
27 from where their author's other catalogued mods sit, 240 inferred
from their neighbours, 21 from curated overrides, and 706 are not
categorised at all. 5,315 of the 6,026 sit on a divider position.
...
25 working orders is a small corpus, and it is the binding constraint on
...
706 mods have no category from any source. Almost all appeared in exactly one
