      ...
      <div className="max-w-3xl mx-auto space-y-10">
        ...
        <section className="space-y-4 font-body leading-relaxed">
          ...
          <p>
            ...
            . I'm a software developer, tinkerer, geek, nerd, lover of Dungeons
            and Dragons and avid gamer. I wrote the code, take in submitted
            orders and decide what counts as evidence. The tool is not
            affiliated with Larian Studios, Nexus Mods or mod.io, and nobody
            pays to be placed anywhere in it. All of it is public, so if you
            want to know what it does with your file, you can go and read the
            code that does it.
          </p>
          <p>
        ...
        <section className="space-y-4 font-body leading-relaxed">
          ...
          <p>
            ...
            belongs to, and writes a masterlist of {num(modCount)} mods,{' '}
            {num(summary.placed)} of which land on a known position. The site
            downloads that file and does the sorting in your browser. Nothing
          ...
          <p>
            ...
            Mods, and on mod.io, the platform behind the official in-game mod
            manager. They supply two things the corpus cannot. One is the
            requirements a mod declares on another, which become the hard rules
            that no amount of counting is allowed to override. The other is a
            category for a mod no submitted order has placed yet, which is the
            weakest kind of evidence here and is labelled as such wherever it is
            used.
          </p>
          <p>
