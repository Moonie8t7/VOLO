...
`masterlist/bg3-masterlist.json` covers 11,045 mods. 6,929 were
...
from their neighbours, 42 from curated overrides, and 834 are not
categorised at all. 10,199 of the 11,045 sit on a divider position.
