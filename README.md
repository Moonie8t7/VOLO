...
`masterlist/bg3-masterlist.json` covers 10,588 mods. 6,655 were
categorised from section headers modders wrote in their own orders,
1,776 from name patterns, 1,109 from a Nexus or mod.io listing,
17 from where their author's other catalogued mods sit, 175 inferred
from their neighbours, 35 from curated overrides, and 821 are not
categorised at all. 9,756 of the 10,588 sit on a divider position.
...
821 mods have no category from any source. Almost all appeared in exactly one
