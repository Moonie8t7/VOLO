...
`masterlist/bg3-masterlist.json` covers 10,071 mods. 6,504 were
categorised from section headers modders wrote in their own orders,
1,608 from name patterns, 995 from a Nexus or mod.io listing,
17 from where their author's other catalogued mods sit, 173 inferred
from their neighbours, 34 from curated overrides, and 740 are not
categorised at all. 9,321 of the 10,071 sit on a divider position.
...
740 mods have no category from any source. Almost all appeared in exactly one
