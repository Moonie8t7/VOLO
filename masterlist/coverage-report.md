...
Generated 2026-08-21T21:20:49.552Z by `scripts/mine-corpus.mjs`.

## Corpus

| | |
|---|---|
| Load orders analysed | 111 |
| labelled working | 94 |
| labelled broken | 15 |
| load-after edges promoted from catalogues | 579 |
| unlabelled | 2 |
| Separator headers parsed | 2453 |
| **Unique mods indexed** | **9686** |
| Seen in more than one order | 6389 |
...
this comes from. Only 3 of 111 orders carry it, because the short
...
| Human-authored section header | 5937 | high, a modder put it there |
| Name pattern fallback | 1699 | medium, needs review |
| Nexus or mod.io listing category | 1061 | medium, the author's own words about what the mod is |
...
| Uncategorised | 757 | none, needs community input |
...
|---|---|---|---|
| Category pairs against the working consensus | 23.1% | 23.3% | no, and it points the other way |
| Mods in no working order anywhere | 9% | 0% | yes |
| Declared dependencies not installed | 0.1 | 0.0 | yes |

Measured over 15 broken and 94 working orders, against 157 category conventions, each held by at least 75 percent of at least 500 observed pairs.
...
- **Ordering rules are not derived here.** Pairwise co-occurrence over 94
  working orders overfits badly: most pairs reflect one person's arbitrary sequencing
  rather than a real constraint. Only declared `dependencies` are emitted as hard
  edges. Revisit once submissions reach ~100 orders.
- **757 mods are `unsorted`.** These need community categorisation.
