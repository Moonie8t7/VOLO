...
| | |
|---|---|
| Masterlist mods | 9227 |
| Matched exactly by name | 2133 |
| Matched fuzzily (>= 0.9) | 538 |
| Unmatched | 6556 |
...
- 33 currently unsorted mods would receive a category from their
  Nexus listing.
- 815 mods have a Nexus category that disagrees with the
  masterlist group. Disagreement is information, not an instruction; each needs
  a look before anything changes.
- 1587 dependency edges from author-maintained Requirements tables land
  on matched masterlist mods, 727 of them resolved to a uuid on both
