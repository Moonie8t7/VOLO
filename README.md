...
`masterlist/bg3-masterlist.json` covers 9,238 mods. 5,156 were
categorised from section headers modders wrote in their own orders,
1,831 from name patterns, 1,080 from a Nexus or mod.io listing,
18 from where their author's other catalogued mods sit, 230 inferred
from their neighbours, 29 from curated overrides, and 894 are not
categorised at all. 8,335 of the 9,238 sit on a divider position.
