...
`masterlist/bg3-masterlist.json` covers 7,671 mods. 4,570 were
categorised from section headers modders wrote in their own orders,
1,424 from name patterns, 712 from a Nexus or mod.io listing,
16 from where their author's other catalogued mods sit, 188 inferred
from their neighbours, 24 from curated overrides, and 737 are not
categorised at all. 6,926 of the 7,671 sit on a divider position.
